...
public class PiqnicClient {
        ...
        if (test) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                while ((ln = in.readLine()) != null) {
                    ...
                    BaseFragmentBase fragment = FragmentFactory.createBaseFragment(baseUri, ws[0], new File(base + "/" + baseUri + "/" + ws[1] + ".hdt"), new Peer((PiqnicNode)nodeInstance), new HashSet<>());
                    fragment.addPeers(addFragment(fragment));
                    //fragment.setBloom(nodeInstance.getConstituentsBloomFilter(fragment));
                    fragment.buildBloom();
    ...
    private static List<IPeer> addFragment(FragmentBase fragmentBase) throws IOException {
        ...
        out.println(nodeInstance.getIp() + ";" + nodeInstance.getPort() + ";" + nodeInstance.getId().toString());
