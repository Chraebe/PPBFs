...
public abstract class NodeBase implements INode {
    ...
    final LocationalIndex locationalIndex = new LocationalIndex();
    final PpbfIndex ppbfIndex = new PpbfIndex();
    ...
    public boolean insertFragment(FragmentBase fragmentBase) {
        synchronized (fragments) {
            ...
            //fragmentBase.setBloom(getConstituentsBloomFilter(fragmentBase));
    ...
    @Override
    public Set<MetaFragmentBase> getMetaFragments() {
        //System.out.println("Finding meta fragments");
        Set<MetaFragmentBase> ret = new HashSet<>();

        for(FragmentBase f : fragments) {
            //System.out.println("Fragment");
            ret.add(f.toMetaFragment());
        }
    ...
    @Override
    public void indexLocationalIndex() {
        locationalIndex.build();
    }
    ...
    @Override
    public LocationalIndex getLocationalIndex() {
        return locationalIndex;
    }

    @Override
    public PpbfIndex getPpbfIndex() {
        return ppbfIndex;
    }
}
