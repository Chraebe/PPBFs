...
public interface IPeer {
    ...
    Set<MetaFragmentBase> getMetaFragments(int ttl, UUID id) throws IOException;

    IBloomFilter<String> getConstituentsForFragment(MetaFragmentBase fragment) throws IOException;
}
