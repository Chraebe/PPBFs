...
public class QueryIterPiqnicExt extends QueryIterRepeatApply {
    ...
    public QueryIterPiqnicExt(QueryIterator input, Triple pattern, ExecutionContext cxt, Set<MetaFragmentBase> fragments) {
        super(input, cxt);
    ...
    static class BindMapper extends QueryIter {
        ...
        BindMapper(PiqnicBindings bindings, Triple pattern, ExecutionContext cxt, Set<MetaFragmentBase> fragments) {
            super(cxt);
            this.s = pattern.getSubject();
            this.p = pattern.getPredicate();
            this.o = pattern.getObject();

            PiqnicExtGraph g = (PiqnicExtGraph) cxt.getActiveGraph();
