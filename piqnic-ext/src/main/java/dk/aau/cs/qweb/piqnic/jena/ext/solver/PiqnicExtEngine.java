...
public class PiqnicExtEngine extends QueryEngineMain {
    ...
    public PiqnicExtEngine(Query query, DatasetGraph dataset, Binding input, Context context) {
    ...
    public PiqnicExtEngine(Op op, DatasetGraph dataset, Binding input, Context context) {
    ...
    static QueryEngineFactory factory = new PiqnicExtEngine.PiqnicEngineFactory();
    ...
    static class PiqnicEngineFactory implements QueryEngineFactory {
        ...
        public Plan create(Query query, DatasetGraph dataset, Binding initial, Context context) {
            PiqnicExtEngine engine = new PiqnicExtEngine(query, dataset, initial, context);
