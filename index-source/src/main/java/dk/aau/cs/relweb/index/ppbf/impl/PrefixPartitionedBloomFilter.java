...
import com.anonymous.index.graph.impl.Graph;
...
public class PrefixPartitionedBloomFilter implements IBloomFilter<String> {
    ...
    public IBloomFilter<String> intersect(IBloomFilter<String> other) {
        ...
        String newFilename = "ppbfs/" + filename.substring(filename.lastIndexOf("/") + 1).replace(".hdt.ppbf", "") + "-" + ppbf.filename.substring(ppbf.filename.lastIndexOf("/") + 1).replace(".hdt.ppbf", "") + ".ppbf";
